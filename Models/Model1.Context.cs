...
namespace projemynei.Models
{
    ...
    public partial class HunerlisEntities1 : DbContext
    {
        public HunerlisEntities1()
            : base("name=HunerlisEntities1")
        {
        }
        ...
        public virtual DbSet<Saticilar> Saticilars { get; set; }
        ...
        public virtual ObjectResult<Nullable<int>> SatisidP()
        {
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<Nullable<int>>("SatisidP");
        }
